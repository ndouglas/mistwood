...
#[derivative(Debug)]
pub struct FloatListNotLengthEquals {
...
#[typetag::serde]
impl Condition for FloatListNotLengthEquals {
...
mod tests {
  ...
  fn test_is_met() {
    test_init();
    let condition = FloatListNotLengthEquals {
      list: Box::new(vec![
...
length:
  ...
  value: 1
    ...
    let deserialized: FloatListNotLengthEquals = serde_yaml::from_str(&serialized).unwrap();
