...
#[typetag::serde]
impl Condition for UintLessThan {
...
mod tests {
  ...
  fn test_serde() {
    ...
    assert_eq!(
      serialized,
      r#"{"type":"UintLessThan","left":{"type":"Int","value":1},"right":{"type":"Int","value":1}}"#
    );
    let deserialized: UintLessThan = serde_json::from_str(&serialized).unwrap();
