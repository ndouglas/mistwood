...
#[typetag::serde]
impl Condition for UintGreaterThan {
...
mod tests {
  ...
  fn test_serde() {
    ...
    assert_eq!(
      serialized,
      r#"{"type":"UintGreaterThan","left":{"type":"Int","value":1},"right":{"type":"Int","value":1}}"#
    );
    let deserialized: UintGreaterThan = serde_json::from_str(&serialized).unwrap();
